...
namespace Will
{
    public partial class PuzzlelM : Form
    {
        ...
        private void btnShuffle_Click(object sender, EventArgs e)
        {
            ...
            {
                YesOrNo = MessageBox.Show("Are You Sure To RESTART ?", "Rabbit Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question); // when a user clicks shuffle while timer has strater they will be prompted if they would like to start again
            }
        ...
        private void PuzzlelM_Load(object sender, EventArgs e)
        {
            Shuffle();
        }
    }
