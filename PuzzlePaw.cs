...
namespace Will
{
    public partial class PuzzlePaw : Form
    {
        ...
        {
            InitializeComponent();
            lstOriginalPictureList.AddRange(new Bitmap[] { Properties.Resources.P1, Properties.Resources.P2, Properties.Resources.P3, Properties.Resources.P4, Properties.Resources.question });//adding all the puzzel images from the resource file
        ...
        private void btnShuffle_Click(object sender, EventArgs e)
        {
            ...
            {
                YesOrNo = MessageBox.Show("Are You Sure To RESTART ?", "Paw Patrol Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question); // when a user clicks shuffle while timer has strater they will be prompted if they would like to start again
            }
        ...
        {
            DialogResult YesOrNO = MessageBox.Show("Are You Sure To Quit ?", "Paw Patrol Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            if (inNullSliceIndex != inPictureBoxIndex)// if null pictuer box image is not equal to the pictuerbox index code below will execte
            {
                ...
                {// if current pictuer box and blank pictuer box are neighbous images can be swaped
                    ...
                    if (CheckWin()) //checking if it is a win state then timer will stop
                    {
                        ...
                        MessageBox.Show("Congratulations...\nPaw Patrol crew Is Happy\nTime Elapsed : " + timer.Elapsed.ToString().Remove(8) + "\nTotal Moves Made : " + inmoves, "Paw Patrol Puzzle");
        ...
        private void PuzzlePaw_Load(object sender, EventArgs e)
        {
            Shuffle();
        }
