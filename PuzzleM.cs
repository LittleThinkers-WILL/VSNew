...
namespace Will
{
    public partial class PuzzleM : Form
    {
        ...
        {
            InitializeComponent();
            lstOriginalPictureList.AddRange(new Bitmap[] { Properties.Resources.M1, Properties.Resources.M2, Properties.Resources.M3, Properties.Resources.M4, Properties.Resources.question });//adding all the puzzel images from the resource file
        ...
        private void btnShuffle_Click(object sender, EventArgs e)
        {
            ...
            {
                YesOrNo = MessageBox.Show("Are You Sure To RESTART ?", "Micky Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question); // when a user clicks shuffle while timer has strater they will be prompted if they would like to start again
            }
        ...
        private void PuzzleM_Load(object sender, EventArgs e)
        {
            Shuffle();
        }
