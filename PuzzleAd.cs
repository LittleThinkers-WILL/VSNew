...
namespace Will
{
    public partial class PuzzleAd : Form
    {
        ...
        {
            InitializeComponent();
            lstOriginalPictureList.AddRange(new Bitmap[] { Properties.Resources.Ad1, Properties.Resources.Ad2, Properties.Resources.Ad3, Properties.Resources.Ad4, Properties.Resources.Ad5, Properties.Resources.Ad6, Properties.Resources.Ad7, Properties.Resources.Ad8, Properties.Resources.Ad9, Properties.Resources.question });//adding all the puzzel images from the resource file
        ...
        private void btnPlayAgain(object sender, EventArgs e)
        {
            ...
            {
                YesOrNo = MessageBox.Show("Are You Sure To RESTART ?", "Adventure Time Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question); // when a user clicks shuffle while timer has strater they will be prompted if they would like to start again
            }
        ...
        {
            DialogResult YesOrNO = MessageBox.Show("Are You Sure To Quit ?", "Adventure Time Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            if (inNullSliceIndex != inPictureBoxIndex)// if null pictuer box image is not equal to the pictuerbox index code below will execte
            {
                ...
                {// if current pictuer box and blank pictuer box are neighbous images can be swaped
                    ...
                    if (CheckPuzzle()) //checking if it is a win state then timer will stop
                    {
                        ...
                        MessageBox.Show("Congratulations...\nYour Adventure Time family Is Happy\nTime Elapsed : " + timer.Elapsed.ToString().Remove(8) + "\nTotal Moves Made : " + inmoves, "Adventure Time Puzzle");
        ...
        private void PuzzleAd_Load(object sender, EventArgs e)
        {
            Randomize();
        }
