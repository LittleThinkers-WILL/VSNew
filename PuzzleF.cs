...
namespace Will
{
    public partial class PuzzleF : Form
    {
        ...
        {
            InitializeComponent();
            lstOriginalPictureList.AddRange(new Bitmap[] { Properties.Resources.F1, Properties.Resources.F2, Properties.Resources.F3, Properties.Resources.F4, Properties.Resources.question });//adding all the puzzel images from the resource file
        ...
        private void btnShuffle_Click(object sender, EventArgs e)
        {
            ...
            {
                YesOrNo = MessageBox.Show("Are You Sure To RESTART ?", "Frozen Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question); // when a user clicks shuffle while timer has strater they will be prompted if they would like to start again
            }
        ...
        {
            DialogResult YesOrNO = MessageBox.Show("Are You Sure To Quit ?", "frozen puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            if (inNullSliceIndex != inPictureBoxIndex)// if null pictuer box image is not equal to the pictuerbox index code below will execte
            {
                ...
                {// if current pictuer box and blank pictuer box are neighbous images can be swaped
                    ...
                    if (CheckWin()) //checking if it is a win state then timer will stop
                    {
                        ...
                        MessageBox.Show("Congratulations...\nFrozen crew Is Happy\nTime Elapsed : " + timer.Elapsed.ToString().Remove(8) + "\nTotal Moves Made : " + inmoves, "Frozen Puzzle");
        ...
        private void PuzzleF_Load(object sender, EventArgs e)
        {
            Shuffle();
        }
